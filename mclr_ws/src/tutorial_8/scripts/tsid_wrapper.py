...
class TSIDWrapper:
    ...
    def __init__(self, conf):
        ...
        self.leftHandTask = tsid.TaskSE3Equality("task-left-hand", self.robot, self.conf.lh_frame_name) # the motion task
        
        # NOTE: param need to be tuned
        ...
        self.rightHandTask = tsid.TaskSE3Equality("task-right-hand", self.robot, self.conf.rh_frame_name) # the motion task
